...
@FixMethodOrder(MethodSorters.NAME_ASCENDING)
    public class HardCodedExamples {
        ...
        String token = "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE2ODUzMjQwNTgsImlzcyI6ImxvY2FsaG9zdCIsImV4cCI6MTY4NTM2NzI1OCwidXNlcklkIjoiNTQyNiJ9.Wrh7GY5we9_ivTrq-vAnL0MbUFuN4NSfwYc5OOUre8g";
        ...
        public void bgetCreatedEmployee(){
            ...
            Response response = (Response) preparedRequest.when().get("/getOneEmployee.php");
        ...
        public void acreateEmployee(){
            ...
            response = preparedRequest.when().post("/createEmployee.php");
        ...
        public void cupdateEmployee(){
            ...
            //hitting the endpoint
            response = preparedRequest.when().put("/updateEmployee.php");
            response.then().assertThat().statusCode(200);
            //for verification
        ...
        public void dgetUpdatedEmployee(){
            ...
            response = preparedRequest.when().get("/getOneEmployee.php");
            response.prettyPrint();
            response.then().assertThat().statusCode(200);
